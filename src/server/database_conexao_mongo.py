...
async def connect_db(): # CONEXÃO COM O BANCO
    ...
    db.clients_collection = db.client.teste.clients # CHAMANDO AS COLEÇÕES
    db.address_collection = db.client.teste.address
    db.products_collection = db.client.teste.products
    db.cart_collection = db.client.teste.cart
